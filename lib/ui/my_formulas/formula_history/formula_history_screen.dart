...
class FormulaHistoryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (BuildContext context) => FormulaHistoryViewModel(),
                  ...
                  children: [
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            Text("Sent: ", style: style14),
                                            Text(
                                              formulaData![index].sent == true
                                                  ? "Yes"
                                                  : "No",
                                              style: style14.copyWith(
                                                color:
                                                    formulaData![index].sent ==
                                                            true
                                                        ? greenColor
                                                        : redColor,
                                              ),
                    ...
                    Padding(
                      ...
                      child: CustomButton(
                        text: "Send to Client",
                        onTap: () async {
                          await model.sendEmailWithPdf(
                            formula: formulaData![index],
                          );
                        },
